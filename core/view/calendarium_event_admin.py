...
class SystemObject(SystemManager):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        self.data.update({ 'filter_activity': reverse('core.view.calendarium_event_admin.show_items') })
        toppanel = {
...
def show_items(request):
    ...
    system.template = loader.get_template(system.sheet.get_sheet_file('admin_calendarium_event_list'))
...
def edit_item(request, itemId):
    ...
    system.template = loader.get_template(system.sheet.get_sheet_file('admin_calendarium_event_edit'))
    c = RequestContext(request, system.get_context())
    return HttpResponse(system.template.render(c))
...
def add_item(request):
    ...
    if system.permission.user is None:
        return HttpResponseRedirect(reverse('core.view.userprofileadmin.login'))
    system.manager.new()
    return HttpResponseRedirect(reverse('core.view.calendarium_event_admin.edit_item', args=(system.manager.item.id,)))
