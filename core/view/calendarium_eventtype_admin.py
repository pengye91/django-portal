...
from core.models import CalendarEventType, CalendarEventTypeLanguage
from core.form.calendarium import AdmCalendarEventTypeForm as AdmItemForm
from core.form.calendarium import AdmCalendarEventTypeLanguageForm as AdmItemLanguageForm
...
class SystemObject(SystemManager):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        self.urls.add = 'core.view.calendarium_eventtype_admin.add_item'
        self.urls.edit = 'core.view.calendarium_eventtype_admin.edit_item'
        self.urls.show_items = 'core.view.calendarium_eventtype_admin.show_items'
        self.manager.model = CalendarEventType()
        self.manager.modelLanguage = CalendarEventTypeLanguage()
        ...
        self.manager.debugger.filename = 'calendarium_eventtype_admin.py'
        self.manager.moduleName = '__adm_Calendars__'
        self.data.update({ 'filter_activity': reverse('core.view.calendarium_eventtype_admin.show_items') })
        toppanel = {
...
def show_items(request):
    ...
    system.template = loader.get_template(system.sheet.get_sheet_file('admin_calendarium_eventtype_list'))
...
def edit_item(request, itemId):
    ...
    system.template = loader.get_template(system.sheet.get_sheet_file('admin_calendarium_eventtype_edit'))
    c = RequestContext(request, system.get_context())
    return HttpResponse(system.template.render(c))
...
def add_item(request):
    ...
    if system.permission.user is None:
        return HttpResponseRedirect(reverse('core.view.userprofileadmin.login'))
    system.manager.new()
    return HttpResponseRedirect(reverse('core.view.calendarium_eventtype_admin.edit_item', args=(system.manager.item.id,)))
