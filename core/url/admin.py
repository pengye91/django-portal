...
urlpatterns += patterns('',
    ...
    url(r'^adv/groups/', include('core.url.adv_category_admin')),
    url(r'^adv/clients/', include('core.url.adv_client_admin')),
    url(r'^adv/adv/', include('core.url.adv_admin')),
    ...
    url(r'^modules/registered/', include('core.url.module_admin')),
